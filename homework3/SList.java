...
public class SList {
  ...
  public void squish() {
	...
	while(size>2 && curNode.next !=null){
		if(curNode.item.equals(curNode.next.item)){
...
// twin method1
  public void twin() {
	...
	SListNode curNode = head;
	while(curNode !=null){
		SListNode newNode = new SListNode(curNode.item,curNode.next);// newNode is a copy of curnode with pointer alsp point to curnode.next
		curNode.next = newNode;
		curNode = curNode.next.next;// move pointer
	}
  }
  /* twin method2
 public void twin() {
	...
	SListNode curNode = head;
	while(curNode !=null){
		SListNode newNode = new SListNode(curNode.item);
