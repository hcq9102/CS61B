...
//modify: keep track tail node
  ...
  public static void main (String[] args) {
	...
	node.insertFront(new Integer(12));
	node.insertFront(new Integer(9));
	node.insertFront(new Integer(6));
	System.out.println("result of toString : " + node.toString());
	node.insertFront(new Integer(3));
	node.insertEnd(new Integer(15));
	System.out.println("result of toString : " + node.toString());
